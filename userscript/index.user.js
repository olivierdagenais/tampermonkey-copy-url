...
// @updateURL https://github.com/olivierdagenais/tampermonkey-copy-url/raw/release/2.19/userscript/index.user.js
// @downloadURL https://github.com/olivierdagenais/tampermonkey-copy-url/raw/release/2.19/userscript/index.user.js
// @match *://*/*
...
class JenkinsConfigure extends GoToAction_1.GoToAction {
    navigate(doc, urlString) {
        ...
        if (breadCrumbListItems) {
            ...
            if (isUrlToRun) {
                const penultimateItem = breadCrumbListItems.item(breadCrumbListItems.length - 2);
            ...
            const lastItem = breadCrumbListItems.item(breadCrumbListItems.length - 1);
