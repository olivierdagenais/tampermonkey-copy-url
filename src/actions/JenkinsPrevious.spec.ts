...
<html>
    <head>
        <title>Project » Repository » Branch #2 Console [Jenkins]</title>
    </head>
    <body
        data-model-type="org.jenkinsci.plugins.workflow.job.WorkflowRun"
        id="jenkins"
    ...
    const actual = testNavigate(
        html,
        "http://localhost:8080/job/Project/job/Repository/job/Branch/2/consoleFull"
    );
